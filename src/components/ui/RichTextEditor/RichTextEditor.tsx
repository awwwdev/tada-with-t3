...
const Editor: React.FC<EditorProps> = ({ content, onContentChange, onEditorReady, direction }) => {
  ...
  function getButtonClass(format: string) {
    return `${editor?.isActive(format) ? "c-base11" : ""}`;
  }
    ...
    <div style={{ direction: direction }}>
      <div className="flex flex-wrap gap-6">
        ...
        <button
          ...
          className={`${editor?.isActive("heading", { level: 1 }) ? "c-base11" : ""}`}
        >
          <Icon
            name={`${
        ...
        <button
          ...
          className={`${editor?.isActive("heading", { level: 2 }) ? "c-base11" : ""}`}
        >
          <Icon
            name={`${
        ...
        <button
          ...
          className={`${editor?.isActive("heading", { level: 3 }) ? "c-base11" : ""}`}
        >
          <Icon
            name={`${
        ...
        {/* <button
          ...
          className={`${editor?.isActive("heading", { level: 4 }) ? "c-base11" : ""}`}
        >
          <Icon
            name={`${
        ...
        {/* <button
          ...
          className={`${editor?.isActive("heading", { level: 5 }) ? "c-base11" : ""}`}
        >
          <Icon
            name={`${
        ...
        {/* <button
          ...
          className={`${editor?.isActive("heading", { level: 6 }) ? "c-base11" : ""}`}
        >
          <Icon
            name={`${
      ...
      <EditorContent editor={editor} className="focus-within:bg-base3 bg-base2A p-6 rd-2" />
    </div>
  );
};
